    ...
    <div className="md:col-span-2">
      <main class="px-16 py-6 bg-gray-100">
        <div className="flex justify-center md:justify-end">
          <a href="#" className="btn text-red-400 border-red-400 md:border-2">
            Log in
          </a>
          <a href="#" className="btn text-red-400 ml-2 border-red-400 md:border-2">
            Sign up
          </a>
        </div>
        ...
        <div>
          ...
          <div className="flex justify-center">
            <div className="btn bg-gray-200 text-gray-400">Load more</div>
          </div>
        </div>
      </main>
    </div>
